...
module.exports = function(sails) {
  ...
  function Configuration() {
    ...
    this.defaults = function defaultConfig(appPath) {
      ...
      let monorepoNodeModulesContainerPath;
      try {
        if (fs.existsSync(path.resolve(appPath, '../../'))) {
          monorepoNodeModulesContainerPath = path.resolve(appPath, '../../');
        }
      } catch (e) {
      }
      ...
      return {
        ...
        // CUSTOM BY QB
        monorepoNodeModulesContainerPath: monorepoNodeModulesContainerPath,
